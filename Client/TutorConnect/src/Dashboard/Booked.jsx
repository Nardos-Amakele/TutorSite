...
const Booked = () => {
 ...
 const fetchBookings = async () => {
  try {
    ...
    const response = await fetch("http://localhost:5000/student/bookings", {
  ...
  const handleCancelConfirm = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/student/bookings/${selectedBooking.id}/cancel`, {
        method: 'PATCH',
        headers: {
          "content-type": "application/json",
          "authorization": `Bearer ${token}`
  ...
  const handleCompleteConfirm = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5000/student/bookings/${selectedBooking.id}/complete`, {
        method: 'PATCH',
        headers: {
          "content-type": "application/json",
          "authorization": `Bearer ${token}`
